...
/**
  ...
  */
SPIDMAClass::SPIDMAClass() : _CSPinConfig(NO_CONFIG)
{
...
/**
  ...
  *         of the class.
  */
SPIDMAClass::SPIDMAClass(uint8_t mosi, uint8_t miso, uint8_t sclk, uint8_t ssel) : _CSPinConfig(NO_CONFIG)
{
  _spi.pin_miso = digitalPinToPinName(miso);
  _spi.pin_mosi = digitalPinToPinName(mosi);
...
/**
  ...
  */
void SPIDMAClass::beginTransaction(uint8_t _pin, SPISettings settings)
{
  uint8_t idx;
...
/**
  ...
  */
void SPIDMAClass::endTransaction(uint8_t _pin)
{
  if (_pin > NUM_DIGITAL_PINS) {
    return;
  }
...
/**
  ...
  */
void SPIDMAClass::setBitOrder(uint8_t _pin, BitOrder _bitOrder)
{
  if (_pin > NUM_DIGITAL_PINS) {
    return;
  }
...
/**
  ...
  *         SPI_MODE3             1                     1
  */
void SPIDMAClass::setDataMode(uint8_t _pin, uint8_t _mode)
{
  if (_pin > NUM_DIGITAL_PINS) {
    return;
  }
...
/**
  ...
  */
void SPIDMAClass::setClockDivider(uint8_t _pin, uint8_t _divider)
{
  if (_pin > NUM_DIGITAL_PINS) {
    return;
  }
...
/**
  ...
  *         several CS pin.
  */
void SPIDMAClass::send(uint8_t _pin, void *_buf, size_t _count, SPITransferMode _mode)
{
  ...
  spi_dma_send(&_spi, ((uint8_t *)_buf), _count, SPI_TRANSFER_TIMEOUT);
...
/**
  ...
  */
byte SPIDMAClass::transfer(uint8_t _pin, uint8_t data, SPITransferMode _mode)
{
  uint8_t rx_buffer = 0;
  ...
  spi_dma_transfer(&_spi, &data, &rx_buffer, sizeof(uint8_t), SPI_TRANSFER_TIMEOUT);
...
/**
  ...
  */
uint16_t SPIDMAClass::transfer16(uint8_t _pin, uint16_t data, SPITransferMode _mode)
{
  ...
  spi_dma_transfer(&_spi, (uint8_t *)&data, (uint8_t *)&rx_buffer, sizeof(uint16_t), SPI_TRANSFER_TIMEOUT);
...
/**
  ...
  *         several CS pin.
  */
void SPIDMAClass::transfer(uint8_t _pin, void *_buf, size_t _count, SPITransferMode _mode)
{
  if ((_count == 0) || (_buf == NULL) || (_pin > NUM_DIGITAL_PINS)) {
    return;
  }
  ...
  spi_dma_transfer(&_spi, ((uint8_t *)_buf), ((uint8_t *)_buf), _count, SPI_TRANSFER_TIMEOUT);
...
/**
  ...
  *         several CS pin.
  */
void SPIDMAClass::transfer(byte _pin, void *_bufout, void *_bufin, size_t _count, SPITransferMode _mode)
{
  ...
  spi_dma_transfer(&_spi, ((uint8_t *)_bufout), ((uint8_t *)_bufin), _count, SPI_TRANSFER_TIMEOUT);
...
/**
  ...
  */
void SPIDMAClass::usingInterrupt(uint8_t interruptNumber)
{
...
/**
  * @brief  Not implemented.
  */
void SPIDMAClass::attachInterrupt(void)
{
...
/**
  * @brief  Not implemented.
  */
void SPIDMAClass::detachInterrupt(void)
{
